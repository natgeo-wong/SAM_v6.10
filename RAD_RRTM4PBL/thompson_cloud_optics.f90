...
!bloss: not needed at present  use netcdf
  use grid, only: rundatadir, masterproc, dompi, reff_ice_holds_Dge, doThompsonReffIce
...
contains
  ...
  subroutine compute_thompson_cloud_optics(nx, nz, ilat, layerMass, cloudFrac, &
    ...
    if( (.NOT.reff_ice_holds_Dge) .AND. (.NOT.doThompsonReffIce) ) then
